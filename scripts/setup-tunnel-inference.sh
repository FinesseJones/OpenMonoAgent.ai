...
# ─────────────────────────────────────────────────────────────────────
# OpenMonoAgent.ai — Set up frp client on the inference box.
...
if [[ -z "$RELAY_TOKEN" ]]; then
    echo ""
    echo -e "${BLUE}OpenMonoAgent.ai${NC} — Relay Tunnel Setup"
    echo "─────────────────────────────────────────"
    echo ""
...
# frp client — OpenMonoAgent.ai inference-box side
...
[Unit]
Description=frp client (OpenMonoAgent.ai inference-box side)
